...
- [x] M77: Bumped the live-login container's memory limit — Chrome's renderer was getting OOM-killed navigating Colaberry's real site
  ...
  - Next Actions: Deploy to production and confirm a full end-to-end pass: video renders, Chrome survives real navigation on Colaberry's actual site, login completes, "I'm logged in — Continue" successfully saves the session.
